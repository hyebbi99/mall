...
public class PolicyHandler{
    ...
    @StreamListener(value=KafkaProcessor.INPUT, condition="headers['type']=='DeliverCancelled'")
    public void wheneverDeliverCancelled_UpdateStatus(@Payload DeliverCancelled deliverCancelled){

        DeliverCancelled event = deliverCancelled;
        System.out.println("\n\n##### listener UpdateStatus : " + deliverCancelled + "\n\n");
